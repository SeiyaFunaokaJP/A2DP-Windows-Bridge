...
| [libopenaptx](https://github.com/pali/libopenaptx) | LGPL-2.1+ | aptX / aptX HD エンコーダー |
...
aptX および aptX HD は Qualcomm の商標です。libopenaptx ライブラリはクリーンルーム実装です。aptX エンコーディングは一部の法域で特許の対象となる場合があります。
